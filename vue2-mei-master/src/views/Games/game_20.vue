...
<div>
  ...
  <div class="nav_o">
  	<ul>
  		<li  v-for="(itmek,indexNav) in datas"  @click="changgeNav(itmek,indexNav)" :class="{isShowNav:updownB&&indexNav>3}">{{itmek.name}}<span  @click.stop='updown()'></span></li>
  	</ul>
  </div>
  <!-- <div class="lhc_nav_bar">
    <ul>
      <li v-for="(itmek,indexNav) in datas">
        <button :class="{active:indexNav==nav_i}" @click="changgeNav(itmek,indexNav)" :disabled="indexNav==nav_i">{{itmek.name}}</button>
      </li>
...
console.log(this.nav_i,'dddddddd');
      if (this.nav_i == 8) {
          // console.log("222");
          ...
          console.log(this.indexT+"xiaosi");
          if (this.objects.length < this.indexT) {
            ...
            setTimeout(this.isSHowff, 1200)
            return
          }else if(this.objects.length>15) {
            this.wenzi = `最多选择8个号码`
            this.isShowS = true;
            this.objects = [];
            setTimeout(this.isSHowff, 1200)
				...
				li {
					...
					.isred:before {
						   content: "";
			                width: 0;
			                height: 0;
			                border-top: 11/20rem solid #ed0132;
		...
		ul {
			>li {
				...
				>ul {
					...
					li:nth-child(45),li:nth-child(46),li:nth-child(47),li:nth-child(48),li:nth-child(49){
						 width: 3.2rem;
						 button{
						 	width: 2.63333333rem;
						 }
		...
		ul {
			>li {
				...
				>ul {
					...
					li:nth-child(17),li:nth-child(18),li:nth-child(19),li:nth-child(20){
						>button{
							margin-bottom: 8/45rem;
						}
...
.nav_o ul{
  ...
  flex-flow: row wrap;
   ...
   li:nth-child(5), li:nth-child(6), li:nth-child(7), li:nth-child(8), li:nth-child(9), li:nth-child(10), li:nth-child(11), li:nth-child(12),li:nth-child(13)
   {
     background: #4c4c4c;
     opacity: 0.9;
   }
